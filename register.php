...
<section id="ol_before" class="ol">
    <h2>회원로그인</h2>
    <form name="foutlogin" action="http://localhost/g6/bbs/login_check.php" onsubmit="return fhead_submit(this);" method="post" autocomplete="off">
    <fieldset>
        <input type="hidden" name="url" value="%2Fg6%2Fbbs%2Fregister.php">
...
<!-- } 로그인 전 아웃로그인 끝 -->
    ...
    <div id="container">
        <div id="container_title">회원가입약관</div>
<!-- 회원가입약관 동의 시작 { -->
<div class="mbskin">
    <form  name="fregister" id="fregister" action="http://localhost/g6/bbs/register_form.php" onsubmit="return fregister_submit(this);" method="POST" autocomplete="off">
...
<a href="http://localhost/g6/bbs/register.php?device=mobile" id="device_change">모바일 버전으로 보기</a>
